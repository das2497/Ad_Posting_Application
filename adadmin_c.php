                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                $rs = Database::search("SELECT *
                                  ...
                                  WHERE ad_ad.ad_badge_adbg_id='3' OR ad_ad.ad_badge_adbg_id='4' 
                                ...
                                ?>
                                        ...
                                        ?>
                                            <div class="row border border-danger rounded shadow ad mt-4 " style="background-color: #ff6bab;" onclick="bdg_body(<?= $d['ad_id']; ?>);">
                                            <?php
                                        }
                            ...
                            <div class="col-12">
                                ...
                                $rs = Database::search("SELECT *
                                  ...
                                  INNER JOIN ad_user ON ad_ad.ad_user_ausr_id=ad_user.ausr_id
                                  INNER JOIN ad_badge ON ad_ad.ad_badge_adbg_id=ad_badge.adbg_id 
                                  WHERE ad_ad.ad_badge_adbg_id='1' OR ad_ad.ad_badge_adbg_id='2' 
                                  ORDER BY ad_time DESC;");
