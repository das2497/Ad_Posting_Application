            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-8 offset-2 d-grid">
                        <button class="btn btn-blinking">POST YOUR AD HERE</button>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12">
                        ...
                        ?>
                            <div class="row border border-warning rounded shadow ad mt-4 " onclick="bdg_body();">
                                <div class="col-4 d-flex flex-column ">
                                    <img class="img-fluid d-none d-lg-block" src="images/N-18388479.webp" alt="">
                                    <img class="d-block d-lg-none" src="images/N-18388479.webp" alt="" style="width: 120px; height: 120px;">
                                    <span class="badge rounded-pill text-primary px-4 py-1" style="font-size: 10px;">
                                ...
                                <div class="col-8">
                                    <h4 class="d-inline"><?php echo mb_substr("💦👙Live Cam Show👙💦", 0, 9, 'UTF-8'); ?>...</h4>
                        ...
                        <div class="news-style-two">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    ?>
                                        <div class="row border border-primary rounded shadow ad mt-4 " onclick="bdg_body();">
                                            <div class="col-4 d-flex flex-column ">
